...
{
    public Repository(InterviewContext dbContext, IMapper mapper) : base(dbContext, mapper)
    {
    }
}
...
{
    public ReadRepository(InterviewContext dbContext, IMapper mapper) : base(dbContext, mapper)
    {
    }
}